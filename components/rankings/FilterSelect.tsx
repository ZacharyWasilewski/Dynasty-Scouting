  ...
  return (
    <label className="relative flex items-center">
      ...
      <select
        {...props}
        className={cn(
          "appearance-none border border-border-strong bg-surface py-2 pl-3 pr-9 text-base text-ink transition-colors duration-150 hover:border-border-strong focus:border-accent/60 focus:outline-none focus:ring-2 focus:ring-accent/10",
          className
        )}
      >
        {children}
