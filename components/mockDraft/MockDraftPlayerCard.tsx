    ...
    <div>
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1 self-center">
          ...
          <p className="mt-2 text-[10px] text-ink-tertiary">{prospect.hasDraftData === true ? "DD Score" : "Pre-Draft Score"}</p>
      ...
      <div className="mt-4 grid grid-cols-3 overflow-hidden rounded-xl border border-border bg-void/25">
        <div className="p-2.5">
          <p className="text-[10px] text-ink-tertiary">DD Rank</p>
        ...
        <div className="border-l border-border p-2.5">
          <p className="text-[10px] text-ink-tertiary">{tierHistoryLabel(prospect, "mock")} tier history</p>
          <p className="mt-1 font-headline text-xl leading-none tabular-nums text-ink">{tierHitRate !== undefined ? `${tierHitRate.toFixed(0)}%` : "—"}</p>
          <p className="mt-1 text-[10px] text-ink-tertiary">n={tierSampleSize ?? 0}{(tierSampleSize ?? 0) < 10 ? " · Small sample" : ""}</p>
        </div>
        <div className="border-l border-border p-2.5">
          <p className="text-[10px] text-ink-tertiary">Community</p>
