...
import { BarChart2 } from "@/components/ui/SiteIcons";

// A controlled dark-to-medium gradient, not dark-to-pale like the
// original dark-theme version — a pale, washed-out blue that popped
// nicely against near-black would have had poor, possibly illegible
// contrast against the new light background. Every step here still
// needs to read clearly as a real bar, not just fade toward
// invisible the way it could on the old palette.
const ROUND_COLORS = ["#1A3382", "#2955C4", "#3D7CE8", "#7CADF2"];
...
export function RoundBreakdownChart({
  ...
  return (
    <div>
      ...
      <p className="mb-1.5 text-[10px] text-ink-tertiary sm:hidden">
        Scroll to see all →
      </p>
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          ...
                          backgroundColor: val !== null ? ROUND_COLORS[ri] : "var(--color-border)",
                        }}
                      />
                    </div>
                  );
