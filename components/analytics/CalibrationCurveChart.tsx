  ...
  return (
    <div>
      ...
      <p className="mb-5 font-mono text-[9px] uppercase tracking-widest text-ink-tertiary">
        The same curve is used for 1QB and Superflex because Positional Score is not format-dependent.
      </p>
        ...
        <>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-x-5 gap-y-2">
            <span className="flex items-center gap-1.5 font-mono text-[11px] text-ink-tertiary">
              ...
              Fitted historical relationship
            </span>
            <span className="flex items-center gap-1.5 font-mono text-[11px] text-ink-tertiary">
          ...
          <p className="mt-3 max-w-xl text-xs leading-relaxed text-ink-tertiary">
            {mode === "weighted" ? (
              <>
                The blue line fits average outcome quality to Positional Score.
                Each gray dot shows the actual average outcome for {position}s
                in that 10-point score range; bigger dots represent larger samples.
                The curve is fitted to the same historical sample shown here.
                This is not a test on unseen players.
              </>
            ) : (
              <>
                The blue line fits historical hit rates to Positional Score.
                Each gray dot shows the actual hit rate for {position}s in that
                10-point range; bigger dots represent larger samples. Differences
                show where the fitted curve runs above or below the observed rate.
                The curve is fitted to the same historical sample shown here.
                This is not a test on unseen players.
              </>
            )}
