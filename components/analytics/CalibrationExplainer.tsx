...
const STAGES = [
  {
    ...
    detail: "Judged on quantitative college metrics — ignores mock draft data, opportunity, and real draft position entirely.",
  },
  {
  ...
  },
  {
    ...
    detail: "Calibrates the core positional grade against historical outcomes. The positional grade already includes opportunity.",
  },
];
...
export function CalibrationExplainer() {
  return (
    <div className="border border-border bg-surface p-6 sm:p-8">
      <span className="font-headline text-sm uppercase text-accent">How A Score Is Built</span>
        ...
        {STAGES.map((stage, i) => (
          <div key={stage.label} className="flex flex-1 items-stretch">
            <div className="flex-1 border border-border bg-surface-raised p-4">
              <p className="font-headline text-sm uppercase text-ink-tertiary">{stage.label}</p>
