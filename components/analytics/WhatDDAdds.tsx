    ...
    <section className="border border-border-strong bg-surface p-6 sm:p-8">
      ...
      <div className="mt-7 grid gap-5 lg:grid-cols-2">
        <div className="border border-border bg-void/20 p-5">
          <p className="font-headline text-sm uppercase text-ink-tertiary">Does DD separate players within a round?</p>
        ...
        <div className="border border-border bg-void/20 p-5">
          ...
          <div className="mt-4 space-y-4">
            <div>
              <p className="text-[10px] text-riser">Late-draft hits</p>
            ...
            <div>
              <p className="text-[10px] text-faller">Round-1 misses</p>
