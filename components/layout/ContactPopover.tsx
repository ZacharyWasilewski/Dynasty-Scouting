...
export function ContactPopover() {
  ...
  return (
    <>
      ...
      {open && (
        <DialogSurface onClose={() => setOpen(false)} aria-label="Contact"  className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-void/80 backdrop-blur-sm" onClick={() => setOpen(false)} />
          <div className="relative z-10 max-h-[85dvh] overflow-y-auto w-full max-w-sm border border-border-strong bg-surface p-6 shadow-xl sm:p-8">
            <button
            ...
            <div className="flex items-center gap-2 text-accent">
              ...
              <span className="font-headline text-sm uppercase">Contact</span>
            </div>
