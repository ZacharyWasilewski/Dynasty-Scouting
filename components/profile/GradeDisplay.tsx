...
export function GradeDisplay({
  ...
  return (
    <div className="relative inline-flex flex-col">
      ...
      {info && showPopup && (
        <DialogSurface onClose={() => setShowPopup(false)} aria-label="Score information"  className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative z-10 max-h-[85dvh] overflow-y-auto w-full max-w-sm border border-border-strong bg-surface p-6 shadow-xl">
            ...
            <span className={cn("font-headline text-sm uppercase text-accent")}>{label}</span>
