...
export function CornerFrame({
  ...
  return (
    <div
      className={cn(
        "group relative border border-border bg-surface p-6 transition-all duration-200 ease-out hover:border-border-strong hover:bg-surface-raised active:scale-[0.98]",
        className
      )}
    >
