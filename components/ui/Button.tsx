...
const variantStyles: Record<ButtonVariant, string> = {
  primary:
    "bg-accent text-void hover:bg-accent-soft active:bg-accent-dim shadow-[0_0_0_1px_rgba(232,163,61,0.4)] hover:shadow-[0_0_0_1px_rgba(232,163,61,0.5),0_8px_24px_-8px_rgba(232,163,61,0.35)]",
  secondary:
