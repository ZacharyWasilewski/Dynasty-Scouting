      ...
      <Container>
        <div className="max-w-2xl">
          ...
          <p className="mt-4 text-base leading-relaxed text-ink-secondary">
            Most rookie rankings follow the general sports media consensus with a few tweaks. Dynasty Database grades every prospect using actual data that has historically led to results.
          </p>
        </div>
