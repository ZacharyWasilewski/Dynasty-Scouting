      ...
      <Container>
        <div className="grid gap-8 lg:grid-cols-[1fr_1.05fr] lg:items-end">
          <div className="max-w-2xl">
            <span className="font-headline text-sm uppercase text-accent">Research layer</span>
        ...
        <div className="mt-12 grid gap-4 lg:grid-cols-[1.15fr_0.85fr]">
          <Link href="/players" prefetch={false} className="group border border-border bg-void p-6 transition-colors hover:border-accent/50 sm:p-8">
            <div className="flex items-center justify-between gap-4">
              ...
              <span className="text-[10px] text-ink-tertiary">Live board · {format.replace("_", " ")}</span>
            </div>
            <div className="mt-10 flex flex-wrap items-end justify-between gap-6">
              <div>
                {/* Was labeled "Current class" — misleading: this list
                    is the top 3 scores across the entire live board
                    (any class, drafted or pre-draft), which is usually
                    dominated by historically elite drafted players, not
                    this year's incoming class (that's what the
                    NextClassSpotlight section above already covers). */}
                <span className="font-headline text-sm uppercase text-ink-tertiary">All-time leaderboard</span>
          ...
          <Link href="/classes" prefetch={false} className="group flex min-h-[360px] flex-col border border-border bg-void p-6 transition-colors hover:border-accent/50 sm:p-8">
            <div className="flex items-center justify-between gap-4">
              ...
              <span className="text-[10px] text-ink-tertiary">Historical lab</span>
            </div>
            <div className="mt-auto pt-12">
              <span className="font-headline text-sm uppercase text-ink-tertiary">Resolved outcomes</span>
