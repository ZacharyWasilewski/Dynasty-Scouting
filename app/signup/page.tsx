    ...
    <main className="flex min-h-[calc(100dvh-4rem)] items-center bg-grid-columns py-12">
      <Container className="max-w-sm">
        ...
        <p className="mt-2 text-sm text-ink-secondary">
          Keep your prospect research and draft preparation together.
        </p>

        <ul className="mt-3 list-disc space-y-1.5 pl-5 text-sm text-ink-secondary">
          <li>Save your watchlist and custom class boards.</li>
          <li>Revisit mock drafts completed while logged in.</li>
          <li>Connect your Sleeper team for draft recommendations based on team needs.</li>
        </ul>

        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          <div>
            <label htmlFor="email" className="font-headline text-sm uppercase text-ink-tertiary">
              Email
            </label>
            <input
              id="email"
          ...
          <div>
            <label htmlFor="password" className="font-headline text-sm uppercase text-ink-tertiary">
              Password
            </label>
            <input
              id="password"
        ...
        <p className="mt-4 text-xs leading-relaxed text-ink-secondary">
          Learn what we store, how sharing works, and how to delete your account in our{" "}
          <Link href="/privacy" className="text-accent underline">Privacy &amp; Data Handling</Link> page.
        </p>
