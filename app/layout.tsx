...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: SITE_DESCRIPTION,
    url: SITE_URL,
    // No images array here on purpose — app/opengraph-image.tsx (a
    // Next.js file-convention route) is picked up automatically for
    // this and every page that doesn't define its own, the same way
    // a player profile's own generated image already overrides it.
    // Explicitly listing a static file here would conflict with
    // that, producing two different og:image tags. Replaces a static
    // PNG that had a transparent background (invisible white text on
    // most platforms' white preview cards) and was 845×270, not the
    // 1200×630 this metadata already claimed it was — reported
    // directly, with a screenshot.
  },
  twitter: {
    card: "summary_large_image",
    title: SITE_TITLE,
    description: SITE_DESCRIPTION,
    // Same reasoning as openGraph.images above — twitter-image
    // resolves to the same opengraph-image.tsx automatically.
  },
