...
const TIER_BLURBS: Record<string, string> = {
  ...
  Starter: "A strong fantasy prospect grade; not a guarantee of an NFL starting role.",
  ...
  "Roster Clogger": "The lowest model tier for expected fantasy impact.",
};

const TERMS: { term: string; blurb: string }[] = [
  { term: "Raw Score", blurb: "Quantitative prospect metrics before projected draft capital, actual draft position, or qualitative opportunity. Available inputs vary by position." },
  {
    term: "DD Score",
    blurb:
    ...
    <main>
      ...
      <section className="py-8 sm:py-14">
        <Container className="max-w-2xl">
          ...
          <h2 className="mt-8 font-display text-xl font-semibold text-ink sm:mt-12">The 8 tiers</h2>
