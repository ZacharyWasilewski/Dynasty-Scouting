  ...
  return (
    <main>
      <SectionIntro
        ...
        description="A shared, read-only snapshot of one person's own board — scores and tiers reflect the model right now, but the order is exactly as they left it."
      />
      <section className="py-10">
        <Container className="max-w-2xl">
          <div className="border border-border bg-surface">
            {ranked.map((p, i) => {
              const format: "1QB" | "SUPERFLEX" = "1QB";
              ...
              return (
                ...
                >
                  <span className="w-7 shrink-0 text-center font-mono text-xs text-ink-tertiary">{i + 1}</span>
