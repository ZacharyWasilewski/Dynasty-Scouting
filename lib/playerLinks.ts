 ...
 */
export const FORMAT_QUERY_PARAM: Record<LeagueFormat, string> = {
  "1QB": "1qb",
  SUPERFLEX: "sf",
  "1QB_TEP": "1qb-tep",
...
export function formatFromParam(value: string | null): LeagueFormat {
 if (value && Object.prototype.hasOwnProperty.call(FORMAT_QUERY_PARAM, value)) return value as LeagueFormat;
 return (Object.entries(FORMAT_QUERY_PARAM).find(([, v]) => v === value)?.[0] as LeagueFormat) ?? "SUPERFLEX";
}
